...
- **Функционал**:
  ...
  - **Пользовательские поля**: Настраиваемые поля для разных типов объявлений.

### 2. Админка (`frontadmin/`)
- **Назначение**: Управление сообществами, модерация и общая статистика платформы.
- **Технологии**: Astro 6.3, React 19, Tailwind CSS 4, shadcn/ui, SWR.
- **Функционал**:
  ...
  - **Настройка типов объявлений**: Создание категорий и пользовательских полей для каждой группы.
...
- [Быстрый старт: Пользовательские поля](docs/CUSTOM_FIELDS_QUICK_START.md)
- [Полное руководство по типам объявлений](docs/POST_TYPES_GUIDE.md)
