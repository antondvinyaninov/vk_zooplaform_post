...
Практично: влить этот PR. Открыть Mini App **из сообщества** → внизу вкладка **Профиль** (человечек) → «Разрешить загрузку фото на стену». Это не пункт в управлении группой VK.
