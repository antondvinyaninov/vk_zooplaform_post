...
const transliterate = (text: string) => {
  ...
  return text.split('').map(char => map[char] !== undefined ? map[char] : char).join('').replace(/[^a-zA-Z0-9_]/g, '').toLowerCase();
};
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginTop: 8, alignItems: 'center' }}>
                           <input 
                             ...
                             onChange={e => {
                               ...
                               if (!newFieldVarName || newFieldVarName === transliterate(newFieldLabel)) {
                                 setNewFieldVarName(transliterate(val));
                               }
                             }} 
