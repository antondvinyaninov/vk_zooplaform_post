      ...
      <div style={{
        ...
        <div className="onboarding-features">
          <div className="feature-item">
            ...
            <div>
              ...
              <div className="feature-desc">
                Сколько раз вы переписывали объявления заново, теряли важные детали или ждали ответа в тишине? Наше приложение сохраняет посты у авторов, чтобы им не приходилось начинать всё с нуля. Открытые статусы показывают, где сейчас находится объявление, а мгновенная и понятная обратная связь помогает быстро исправить недочёты. Забудьте о «глухом молчании» — здесь каждый голос услышан, а каждая история важна.
              </div>
            </div>
          </div>
          ...
          <div className="feature-item">
            ...
            <div>
              <div className="feature-title">Комфорт администратора — ваш новый союзник</div>
              <div className="feature-desc">
                Представьте, что вам больше не нужно бесконечно обновлять «предложку» в надежде увидеть новые заявки. Вы получаете уведомления сразу, видите структурированные карточки постов, можете легко редактировать их или отправлять на доработку. А главное — выбираете удобное время для публикации, чтобы помочь максимально эффективно. Теперь ваша работа станет не только проще, но и приятнее.
              </div>
            </div>
          </div>
          ...
          <div className="feature-item">
            ...
            <div>
              <div className="feature-title">Всё только начинается — вместе мы сильнее</div>
              <div className="feature-desc">
                Это лишь первая версия платформы, но впереди — целый мир новых возможностей. Мы создаём инструмент, который сделает помощь животным системной, прозрачной и по-настоящему эффективной. Присоединяйтесь к нашему сообществу, чтобы вместе менять жизни к лучшему. Ведь каждый из нас — часть большой и важной миссии.
              </div>
            </div>
          </div>
        </div>
